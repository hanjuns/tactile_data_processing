...
dir_parent = '/media/hanjuns/disk/food_manipulation/tactile/gelsight/calib_data/'
dir_parent = '/media/hanjuns/disk/food_manipulation/tactile/fingervision/calib_data/'
dir_child = 'gripping_force/1_4/'
...
for trial in range(1, 15):
    ...
    for topic, msg, t in bag.read_messages(topics):
        ...
        elif topic == '/fingervision/fv_3_r/wrench':
            # elif topic == '/gelsight/Wrench':
